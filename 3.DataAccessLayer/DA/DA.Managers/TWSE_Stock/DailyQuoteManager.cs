...
namespace DA.Managers.TWSE_Stock
{
    ...
    public class DailyQuoteManager : IDailyQuoteManager
    {
        ...
        public List<DailyQuote> CrawlDailyQuoteListByDate(DateTime dateTime, StockCategoryEnum stockCategoryEnum = StockCategoryEnum.FinancialAndInsurance)
        {
        ...
        /// 從 <see cref="GetDailyQuoteListByYear(DateTime, StockCategoryEnum)"/> 可以根據 年份 以及 股票分類 取得每日收盤情形列表
        public List<DailyQuote> CrawlDailyQuoteListByMonth(DateTime dateTime, StockCategoryEnum stockCategoryEnum = StockCategoryEnum.FinancialAndInsurance)
        {
            List<DailyQuote> result = new List<DailyQuote>();

            IEnumerable<DateTime> DateTimeEnumerable = dateTime.GetDateTimeRangeByMonthBeforeNow().EachDay();
        ...
        /// 從 <see cref="CrawlDailyQuoteListByDate(DateTime, StockCategoryEnum)"/> 可以根據 日期 以及 股票分類 取得每日收盤情形列表
        /// 從 <see cref="CrawlDailyQuoteListByMonth(DateTime, StockCategoryEnum)"/> 可以根據 月份 以及 股票分類 取得每日收盤情形列表
        public List<DailyQuote> CrawlDailyQuoteListByYear(int year, StockCategoryEnum stockCategoryEnum = StockCategoryEnum.FinancialAndInsurance)
        {
            List<DailyQuote> result = new List<DailyQuote>();
