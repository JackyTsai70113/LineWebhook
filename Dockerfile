...
COPY . .
RUN dotnet build "1.PresentationLayer/UI/Website/Website.csproj" -c Release -o /build
RUN dotnet test "2.BusinessLogicLayer/BL.Service.Tests" -c Release
RUN dotnet publish "1.PresentationLayer/UI/Website/Website.csproj" -c Release -o /publish
