...
namespace Core.Domain.Interafaces.Services {
    ...
    public interface IDailyQuoteService {
        ...
        int GetDailyQuoteListByMonthAndSave(DateTime dateTime, StockCategoryEnum stockCategoryEnum);
        ...
        /// <param name="stockCategoryEnum">股票分類</param>
        /// <returns>儲存數量</returns>
        int GetDailyQuoteListByYearAndSave(int year, StockCategoryEnum stockCategoryEnum);
